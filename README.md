FaceAI implements the insightface inswapper_128 model with a helpful GUI.
...
### To update from Opal-03a, just need to replace the FaceAI folder.
...
### Disclaimer: ###
FaceAI is a personal project that I'm making available to the community as a thank you for all of the contributors ahead of me.
